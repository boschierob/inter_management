...
from sendgrid.helpers.mail import Mail, Attachment, FileContent, FileName, FileType, Disposition, Bcc, CustomArg
...
def run_real_delivery():
    ...
    for msg in messages:
        ...
        mail.add_custom_arg(CustomArg("notion_msg_id", msg_id))
        # ------------------------------------------
